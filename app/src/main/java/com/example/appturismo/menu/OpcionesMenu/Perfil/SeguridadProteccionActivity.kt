...
class SeguridadProteccionActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_seguridad_proteccion)
        ...
        val btnAtras = findViewById<ImageButton>(R.id.btnAtrasSeguridad)

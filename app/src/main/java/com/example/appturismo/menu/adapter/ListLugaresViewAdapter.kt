...
class ListLugaresViewAdapter(private val lugaresList: List<ListLugaresView>) : RecyclerView.Adapter<ListLugaresViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListLugaresViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        return ListLugaresViewHolder(layoutInflater.inflate(R.layout.item_listview, parent, false))
    }
